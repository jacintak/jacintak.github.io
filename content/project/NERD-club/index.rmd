...
I have been an active contributor to NERD club and its sub-groups. This page documents some of the outputs I have produced for peer-learning activities.
...
[Open PDF](/files/24March2021_Advanced_R_Markdown.pdf)
...
## OSM in R
This [tutorial](/post/2021-07-01-OSM-in-R/) describes how to interface with Open Street Maps in `R` to make a map for a present but the same code can be used to make maps for any purpose.
